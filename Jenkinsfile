...
def dockerRegistryPrefix = "mof_tda-worker"
    ...
    ansiColor('xterm') {
      try {
        ...
        stage('test') {
                ...
                sh """
                  sudo docker cp ${dockerTag}-nosetests:/home/mof_tda/coverage.xml .
                  sudo docker cp ${dockerTag}-nosetests:/home/mof_tda/pylint.out .
                """
